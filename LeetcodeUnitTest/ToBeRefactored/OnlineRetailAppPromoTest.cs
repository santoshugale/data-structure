...
{
    public class OnlineRetailAppPromoTest
    {
        [Fact]
        public void EmptyCodeList_Return_1()
        {
            var result = OnlineRetailAppPromo.IsCustomerWinner(new List<List<string>>(), null);
        ...
        {
            var result = OnlineRetailAppPromo.IsCustomerWinner(null, null);
            Assert.Equal(1, result);
        }
        ...
        {
            var result = OnlineRetailAppPromo.IsCustomerWinner(new List<List<string>> { new List<string>() { "Apple", "Orange" } }, new List<string>());
        ...
        {
            var result = OnlineRetailAppPromo.IsCustomerWinner(new List<List<string>> { new List<string>() { "Apple", "Orange" } }, null);
            Assert.Equal(0, result);
        }
        ...
        public void WinnerShoppingList_Return_0()
        {
            ...
            var result = OnlineRetailAppPromo.IsCustomerWinner(codeList, shoppingCart);
            Assert.Equal(0, result);
        }
